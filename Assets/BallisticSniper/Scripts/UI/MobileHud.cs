...
namespace BallisticSniper
{
    ...
    public sealed class MobileHud : MonoBehaviour
    {
        ...
        public void ShowCinematic(int cameraVariant, WeaponDefinition weapon)
        {
            ...
            cinematicLabel.text = "ПОЛЁТ ПУЛИ";
            cinematicWeaponLabel.text = weapon.Name + "  •  " + weapon.Calibre;
        }
        ...
        private void CreateMenu()
        {
            ...
            CreateText(menuRoot.transform, "Offline", new Vector2(0.56f, 0.035f), new Vector2(0.95f, 0.08f), 17, TextAnchor.MiddleRight, new Color32(255, 255, 255, 150)).text = "v5.4.1  •  Миссии + тренировка  •  Оффлайн";
        }
